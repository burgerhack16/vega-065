...
extends Command {
    ...
    List<ParsedName> getPlayerStrings() {
        List<NetworkPlayerInfo> infoList = this.mc.getConnection().getPlayerInfoMap().stream().filter(net -> net.getGameProfile() != null).filter(net -> net.getDisplayName() != null).toList();
    ...
    public JsonObject getJsonParses(String ip) {
        ...
        this.getParsesFinalStrings(false).forEach(str -> object.addProperty(str, ""));
        return object;
    }
    ...
    public void onCommand(String[] args) {
        try {
            ...
            if (args[1].equalsIgnoreCase("dir") || args[1].equalsIgnoreCase("open")) {
                ...
                Sys.openURL((String)this.file.getAbsolutePath());
            }
        }
