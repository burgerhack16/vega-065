...
import ru.govno.client.utils.Command.impl.Kick;
...
import ru.govno.client.utils.Command.impl.ProfilerToggler;
import ru.govno.client.utils.Command.impl.Report;
import ru.govno.client.utils.Command.impl.RidingDRSync;
import ru.govno.client.utils.Command.impl.Server;
...
public class CommandManager {
    ...
    public CommandManager() {
        ...
        this.commands.add(new Server());
        this.commands.add(new Report());
        this.commands.add(new ProfilerToggler());
    }
