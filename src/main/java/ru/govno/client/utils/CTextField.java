...
public class CTextField extends Gui {
    ...
    public void drawTextBox(CFontRenderer font, float alphaPercent) {
        if (this.getVisible()) {
            ...
            if (!s.isEmpty()) {
                ...
                font.drawStringWithShadow(s1, (double)((float)l), (double)((float)i1), i);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                font.drawStringWithShadow(s.substring(j), (double)((float)j1), (double)((float)i1), i);
            }

            if (flag1) {
                if (flag2) {
                    RenderUtils.drawRect((double)k1, (double)(i1 - 1), (double)(k1 + 1), (double)(i1 + 1 + this.fontRendererInstance.getHeight()), -3092272);
                } else {
                    font.drawStringWithShadow("_", (double)((float)k1), (double)((float)i1), i);
                }
            }
