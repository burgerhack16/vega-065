...
extends Module {
    ...
    public Spider() {
        ...
        this.Modes = new ModeSettings("Modes", "MatrixOld", this, new String[]{"MatrixOld", "MatrixNew", "Region", "GrimAc"});
        this.settings.add(this.Modes);
        this.Fast = new BoolSettings("Fast", true, this, () -> this.Modes.getMode().equalsIgnoreCase("Region"));
        this.settings.add(this.Fast);
    }
    ...
    public void onPlayerMotionUpdate(EventPlayerMotionUpdate e) {
        ...
        if (this.Modes.getMode().equalsIgnoreCase("MatrixNew") && this.actived && Minecraft.player.isCollidedHorizontally && !Minecraft.player.isInWater() && !Minecraft.player.isInLava() && !Minecraft.player.isInWeb) {
