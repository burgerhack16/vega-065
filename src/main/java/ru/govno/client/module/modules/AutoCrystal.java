...
extends Module {
    BoolSettings CanUseInventory = new BoolSettings("CanUseInventory", false, this);
    BoolSettings NoSuicide;
    BlockPos pos;
    int ticks;
    ...
    boolean switchAndPlace(BlockPos pos) {
        ...
        if (crystalInvSlot != -1) {
            ...
            if (this.CanUseInventory.getBool()) {
