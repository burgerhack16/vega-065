...
extends Module {
    public List<Totempop> popList = new CopyOnWriteArrayList<Totempop>();
    FloatSettings TimeMs = new FloatSettings("TimeMs", 3000.0f, 6000.0f, 800.0f, this);
    public static TotemPopESP get;
    static long staticTime;

    public TotemPopESP() {
        super("TotemPopESP", 0, Module.Category.RENDER);
        this.settings.add(this.TimeMs);
        get = this;
    }
