...
extends Module {
    ...
    public FloatSettings WX = new FloatSettings("WX", 0.01f, 1.0f, 0.0f, this, () -> false);
    ...
    public CommandGui() {
        ...
        this.WY = new FloatSettings("WY", 0.3f, 1.0f, 0.0f, this, () -> false);
    ...
    public static void drawWindow() {
        if (CommandGui.canDrawWindow()) {
            ...
            RenderUtils.drawClientHudRect(x, y, x + w, y + h + 2.0f, CommandGui.getAlphaPC(), Hud.get.ManyGlows.getBool());
