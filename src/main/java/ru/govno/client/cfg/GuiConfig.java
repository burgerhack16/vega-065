...
extends GuiScreen {
    ...
    void cfgGuiCloser(int mouseX, int mouseY) {
        ...
        if (Mouse.isButtonDown((int)0) && (double)cfgScale.getAnim() < 0.05) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int extendKeys = 40;
        if (HoverUtils.isHovered(this.x + this.w - 16, this.y + this.h, this.x + this.w, this.y + this.h + 16, mouseX, mouseY) && this.isClicked && Mouse.isButtonDown((int)0) && this.keyAddClicked) {
        ...
        } else if (HoverUtils.isHovered(this.x + this.w - 32, this.y + this.h, this.x + this.w - 16, this.y + this.h + 16, mouseX, mouseY) && this.isClicked && Mouse.isButtonDown((int)0) && this.keyAddClicked) {
            this.keyAddClicked = false;
            this.textFieldSearch.setText("");
        }
        ...
        if (HoverUtils.isHovered(this.x + this.h - 96, this.y + this.h - 24 - extendKeys, this.x + this.h - 8, this.y + this.h - 8 - extendKeys, mouseX, mouseY)) {
            HoverkeyRemove = true;
            if (this.isClicked && Mouse.isButtonDown((int)0)) {
        ...
        boolean bl = this.isClicked = !Mouse.isButtonDown((int)0);
        if (this.dragging) {
        ...
        if (HoverUtils.isHovered(this.x, this.y - 24, this.x + this.w, this.y, mouseX, mouseY) && Mouse.isButtonDown((int)0)) {
            this.dragging = true;
        }
        ScaledResolution sr = new ScaledResolution(this.mc);
