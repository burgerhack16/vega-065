...
public class PasswordField extends Gui {
        ...
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtils.smoothAngleRect(
                        (float)(this.xPos - 1),
                        (float)(this.yPos + 4),
                        (float)(this.xPos + this.width + 1),
                        (float)(this.yPos + this.height - 4),
                        ColorUtils.getColor(255, 40, 80)
                );
                RenderUtils.smoothAngleRect(
                        (float)this.xPos, (float)(this.yPos + 5), (float)(this.xPos + this.width), (float)(this.yPos + this.height - 5), -16777216
                );
            }
    ...
    public void func_73800_i(int par1) {
        ...
        if (this.fontRenderer != null) {
            ...
            if (par1 == this.i) {
                this.i = this.i - this.fontRenderer.trimStringToWidth(this.text, var3, true).length();
            }

            if (par1 > var5) {
                this.i += par1 - var5;
            } else if (par1 <= this.i) {
                this.i = this.i - (this.i - par1);
            }
